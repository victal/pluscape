...
describe('Category e2e test', () => {
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle().getAttribute('id')).to.match(/pluscapeApp.category.home.createOrEditLabel/);
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/pluscapeApp.category.delete.question/);
