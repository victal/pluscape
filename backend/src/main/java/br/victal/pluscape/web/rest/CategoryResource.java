...
import br.victal.pluscape.domain.Category;
import br.victal.pluscape.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link br.victal.pluscape.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Api(description = "Operações em categorias")
public class CategoryResource {
    ...
    public ResponseEntity<List<Category>> getAllCategories(Pageable pageable,
                                                           @ApiParam(hidden = true) @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
